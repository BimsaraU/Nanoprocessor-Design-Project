...
set_property PACKAGE_PIN T2 [get_ports {Program[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Program[0]}]
set_property PACKAGE_PIN R3 [get_ports {Program[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Program[1]}]
#set_property PACKAGE_PIN W2 [get_ports {sw[12]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {sw[12]}]
set_property PACKAGE_PIN U1 [get_ports {Step_Mode}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Step_Mode}]
set_property PACKAGE_PIN T1 [get_ports {Type_Sel}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Type_Sel}]
set_property PACKAGE_PIN R2 [get_ports {Display_Mode}]
...
set_property PACKAGE_PIN T18 [get_ports Step_Clk]
	set_property IOSTANDARD LVCMOS33 [get_ports Step_Clk]
